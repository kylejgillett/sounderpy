...
def __test_remove_in_prod__():
    ...
    spy.build_sounding(clean_data, dark_mode=True, save=True, filename="RAOB_Norman-OK_20230129-12.png", parcel_highlight = ["mu_ia_ecape"], parcel_background = ["mu_ia_cape"])
