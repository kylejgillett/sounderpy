...
.. py:function:: spy.build_sounding(clean_data, style='full', color_blind=False, dark_mode=False, save=False, filename='sounderpy_sounding')
...
.. py:function:: spy.build_hodograph(clean_data,  dark_mode=False, sr_hodo=False, save=False, filename='sounderpy_sounding')
...
.. py:function:: spy.build_vad_hodograph(vad_data, dark_mode=False, sr_hodo=False, save=False, filename='sounderpy_sounding')
   ...
   :param save: whether to show the plot inline or save to a file. Default is ``False`` which displays the file inline.
   :type save: bool, optional
   :param filename: the filename by which a file should be saved to if ``save = True``. Default is `sounderpy_hodograph`.
   :type filename: str, optional
   :return: plt, a SounderPy hodograph built with Matplotlib, MetPy, SharpPy, & SounderPy.
   :rtype: plt
...
.. code-block:: python
   ...
   # load a VAD file and create vad_data, a 'SounderPy-style' Python dict
   # See 'VAD Hodograph example'
